import { ExternalLink, Github, ShoppingCart, Calculator, Gamepad2, CreditCard, DollarSign, Shirt, Bot } from "lucide-react"; 
...
const Portfolio = () => {
  const featuredProjects = [
    {
      ...
      description: "A comprehensive full-stack web application for grocery store management featuring product management, billing system, and inventory tracking. Built with modern web technologies for optimal performance.",
      icon: ShoppingCart,
      techStack: ["Django", "Bootstrap", "DB-Browser", "Python"],
      features: ["Product Management", "Billing System", "Inventory Tracking", "User Authentication"],
      githubUrl: "https://github.com/Vignesh-Kandem/cartzy",
      image: "bg-gradient-to-br from-green-500 to-emerald-600"
    },
    {
      title: "Smart Calculator",
      description: "Feature-rich desktop calculator application built with Java Swing, offering both dark and light themes, keyboard input support, and advanced mathematical functions for enhanced user experience.",
      icon: Calculator,
      techStack: ["Java", "Swing", "AWT"],
      features: ["Dark/Light Themes", "Keyboard Input", "Advanced Functions", "Memory Operations"],
  ...
  const otherProjects = [
    ...
    },
    {
      ...
      icon: CreditCard,
      techStack: ["Django", "Stripe API", "PostgreSQL"]
    },
    {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              A showcase of my latest projects demonstrating full-stack development skills,
              problem-solving abilities, and passion for creating innovative solutions.
            </p>
          </div>
          ...
          {/* Other Projects */}
          <div>
            <h3 className="text-2xl font-semibold text-foreground mb-8">More Projects</h3>
          ...
          <div className="mt-16 text-center">
            <div className="bg-gradient-secondary border border-border/50 rounded-2xl p-8">
              ...
              <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                Visit my GitHub profile to see more projects, contributions, and code samples
                showcasing my development journey and technical skills.
              </p>
              <Button
                className="bg-gradient-primary hover:shadow-glow transition-all duration-300 transform hover:scale-105"
                onClick={() => window.open("https://github.com/Vignesh-Kandem", "_blank")}
              >
